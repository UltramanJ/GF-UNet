...
#python train.py --dataset Synapse --cfg configs/swin_tiny_patch4_window7_224_lite.yaml --root_path /home/user/workstation2/SA/Swin-Unet-main/data --max_epochs 300 --output_dir ./output8 --img_size 224 --base_lr 0.005 --batch_size 24
#export LD_LIBRARY_PATH=/home/user/anaconda3/envs/test/lib/python3.8/site-packages/nvidia/cudnn/lib:$LD_LIBRARY_PATH
